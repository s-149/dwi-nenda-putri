                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td width="80%"><label><?=BuatRp($_insentif1)?>.00</label>
                                            ...
                                            <input type="hidden" class="form-control" name="insentif" value="<?=$_insentif?>"  required autofocus />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
 ...
 <?php }
  ...
  if (isset($_POST['simpan'])) {
    ...
    if ($simpan) {
        ...
        $sql = $koneksi->query("INSERT INTO `penggajian`(`tanggal`, `id_karyawan`, `nama_karyawan`, `gaji_pokok`, `tunjangan`, `bagian`, `total_%_kontam`, `insentif`, `gaji_kotor`, `id_absensi`, `gaji_bersih`, `keterangan`) values('$tanggal', '$id_karyawan', '$nama_karyawan', '$gaji_pokok', '$tunjangan', '$bagian', '$total_kontam', '$insentif', '$gaji_kotor', '$id_absensi', '$gaji_bersih', '$keterangan')");
        $sql1 = $koneksi->query("INSERT INTO `penggajian`(`tanggal`, `id_karyawan`, `nama_karyawan`, `gaji_pokok`, `tunjangan`, `insentif`, `gaji_kotor`, `gaji_bersih`) values('$tanggal', '$id_karyawan', '$nama_karyawan', '$gaji_pokok', '$tunjangan', '$insentif', '$gaji_kotor', '$gaji_bersih')");
