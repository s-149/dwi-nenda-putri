<?php
    ...
    $id=$_GET['id'];
    $sql = $koneksi->query("select * from bibit_siap_jual where id_bibit_siap_jual='$id'");
...
?>
                        ...
                        <div class="col-md-6">
                                <table>
                                    ...
                                    <tr>
                                        <td>Nama Bibit</td>
                                        <td></td>
                                        <td><input type="text" class="form-control" name="nama_bibit" value="<?=$data['nama_bibit']?>"  required autofocus /></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
 ...
 <?php
    ...
    if ($simpan) {
        ...
        $sql1 = $koneksi->query("update  `laporan_bibit_siap_jual` SET `tanggal_keluar`='$tanggal_keluar', `code_clone`='$code_clone', `nama_bibit`='$nama_bibit', `no_indukan`='$no_indukan', `jumlah`='$jmlh_unit' where id_bibit_siap_jual='$id'");
