 ...
 <?php
    ...
    if ($simpan) {
        $sql = $koneksi->query("INSERT INTO `bibit_siap_jual`( `tanggal_keluar`, `code_clone`, `nama_bibit`, `no_indukan`, `jmlh_unit`, `keterangan`) values('$tanggal_keluar','$code_clone', '$nama_bibit', '$no_indukan', '$jmlh_unit','$keterangan')");


        $sql1 = $koneksi->query("INSERT INTO `laporan_bibit_siap_jual`( `tanggal_keluar`, `code_clone`, `nama_bibit`, `no_indukan`, `jumlah`) values('$tanggal_keluar','$code_clone', '$nama_bibit', '$no_indukan', '$jmlh_unit')");
