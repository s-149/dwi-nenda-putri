<?php
    ...
    $id=$_GET['id'];
    $sql = $koneksi->query("select * from bibit where id_bibit='$id'");
...
?>
 ...
 <?php
    ...
    if ($simpan) {
        $sql = $koneksi->query("update  `bibit` SET `tanggal_keluar`='$tanggal_keluar', `code_clone`='$code_clone', `nama_bibit`='$nama_bibit', `no_indukan`='$no_indukan', `jmlh_unit`='$jmlh_unit', `keterangan`='$keterangan' where id_bibit='$id'");
