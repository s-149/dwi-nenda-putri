 ...
 <?php
    ...
    if ($simpan) {
        $sql = $koneksi->query("INSERT INTO `bibit`(`tanggal_keluar`, `code_clone`, `nama_bibit`, `no_indukan`, `jmlh_unit`,`keterangan`) values('$tanggal_keluar','$code_clone', '$nama_bibit', '$no_indukan', '$jmlh_unit','$keterangan')");
