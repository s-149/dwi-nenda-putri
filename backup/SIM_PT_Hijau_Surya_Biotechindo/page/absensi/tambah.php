...
<?php } ?>
 ...
 <?php
    ...
    if ($simpan) {
        $sql = $koneksi->query("INSERT INTO `absensi`(`id_absensi`, `tanggal`, `id_karyawan`, `nama_karyawan`, `bagian`, `keterangan`) values('$id_absensi','$tanggal', '$id_karyawan', '$nama_karyawan', '$bagian', '$keterangan')");
        $sql1 = $koneksi->query("INSERT INTO `laporan_absensi`(`id_absensi`, `tanggal`, `id_karyawan`, `nama_karyawan`, `bagian`, `keterangan`) values('$id_absensi','$tanggal', '$id_karyawan', '$nama_karyawan', '$bagian', '$keterangan')");
