                        ...
                        <div class="col-md-6">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="gambar/user/<?php echo $data['Photo'];?>" target="_blank"><img width="50px" src="gambar/user/<?php echo $data['Photo'];?>"></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
    ...
    $Gambar=date('d_M_Y_h_i_s').'_'.$foto;
 	...
 	if ($simpan) {
        ...
        $upload = move_uploaded_file($lokasi, "gambar/user/".$Gambar);
 		...
 		$sql = $koneksi->query("update  admin_user set username='$username', password='$password', level='$level', Photo='$Gambar' where username='$id'");
