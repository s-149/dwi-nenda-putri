 ...
 <?php }
  ...
  if (isset($_POST['simpan'])) {
    ...
    if ($simpan) {
        ...
        $sql = $koneksi->query("update  `penggajian` SET  `tanggal`='$tanggal', `id_karyawan`='$id_karyawan', `gaji_pokok`='$gaji_pokok', `tunjangan`='$tunjangan',`total_%_kontam`='$total_kontam',`intensif`='$intensif',`gaji_kotor`='$gaji_kotor',`id_absensi`='$id_absensi',`gaji_bersih`='$gaji_bersih',`keterangan`='$keterangan'  where id_penggajian='$id_penggajian'");
