<?php
    ...
    $id=$_GET['id'];
    $sql = $koneksi->query("SELECT `id_absensi`, `tanggal`, `id_karyawan`, `nama_karyawan`, `bagian`, `keterangan`, `validasi` FROM `absensi` JOIN `karyawan` USING(`id_karyawan`) where id_absensi='$id'");
...
?>
                        ...
                        <div class="col-md-6">
                                <table>
                                    ...
                                    <tr>
                                        <td>Bagian</td>
                                        <td></td>
                                        <td><input type="text" class="form-control" name="bagian" rows="6" value="<?=$data['bagian']?>" required autofocus readonly ></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
 ...
 <?php
    ...
    if ($simpan) {
        $sql = $koneksi->query("update  `absensi` SET `tanggal`='$tanggal', `id_karyawan`='$id_karyawan', `keterangan`='$keterangan' where id_absensi='$id'");
