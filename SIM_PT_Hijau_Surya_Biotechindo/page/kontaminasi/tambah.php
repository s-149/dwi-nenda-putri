 ...
 <?php
    ...
    if ($simpan) {
        $sql = $koneksi->query("INSERT INTO `kontaminasi`(`id_kontaminasi`, `tanggal`, `id_karyawan`, `code_clone`, `stage`, `jmlh_pot`, `unit_benih_pot`, `jmlh_btl`, `unit_benih_btl`, `keterangan`) values('$id_kontaminasi','$tanggal','$id_karyawan', '$code_clone', '$stage', '$jmlh_pot', '$unit_benih_pot', '$jmlh_btl', '$unit_benih_btl','$keterangan')");
