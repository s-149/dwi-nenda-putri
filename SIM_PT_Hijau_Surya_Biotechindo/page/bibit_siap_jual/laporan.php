...
<?php if (isset($_POST['tampilkan'])) { 
    ...
    ?>
                            ...
                            <div class="table-responsive">
                                <table border="1" class="table table-striped table-bordered table-hover" id="">
                                    <thead>
                                        <td colspan="8">
                                            <center>
                                                ...
                                                <h3>LAPORAN DATA BIBIT SIAP JUAL</h3>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $no = 1;
                                            $sql = $koneksi->query("SELECT * FROM `bibit_siap_jual` JOIN `benih` USING(`code_clone`) where tanggal_keluar between '$tgl_awal' and '$tgl_akhir' ");
                    ...
                    <div style="float: right;">
                        <a class="btn btn-warning" href="cetak_laporan.php?page=bibit_siap_jual&tgl_awal=<?=$tgl_awal?>&tgl_akhir=<?=$tgl_akhir?>" target="_blank"><i class="fa fa-print"></i> CETAK</a>
                    </div>
                </div>
<?php } ?>
