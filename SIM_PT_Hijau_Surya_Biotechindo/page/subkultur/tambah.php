 ...
 <?php
    ...
    if ($simpan) {
        $sql = $koneksi->query("INSERT INTO `subkultur`(`id_subkultur`, `tanggal`, `id_karyawan`, `code_clone`, `stage_awal`, `stage_akhir`, `media`, `jmlh_awal_pot`, `jmlh_akhir_pot`, `jmh_awal_btl`, `jmlh_akhir_btl`, `unit_benih_pot`, `unit_benih_bt`, `jmlh_bakteri`, `durasi`, `keterangan`) values('$id_subkultur','$tanggal','$id_karyawan', '$code_clone', '$stage_awal', '$stage_akhir', '$media', '$jmlh_awal_pot', '$jmlh_akhir_pot', '$jmh_awal_btl', '$jmlh_akhir_btl', '$unit_benih_pot', '$unit_benih_bt', '$jmlh_bakteri', '$durasi', '$keterangan')");
