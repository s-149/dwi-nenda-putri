...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ($simpan) {
        $sql = $koneksi->query("INSERT INTO `penjualan`(`id_penjualan`, `tanggal`, `jenis_penjualan`, `code_clone`, `harga_satuan`, `jumlah`, `total_harga`, `tujuan`, `penerima`, `ekspedisi`, `keterangan`) values('$id_penjualan','$tanggal', '$jenis_penjualan', '$code_clone', '$harga_satuan', '$jumlah', '$total_harga', '$tujuan', '$penerima', '$ekspedisi', '$keterangan')");
        if ($sql) 
            {
